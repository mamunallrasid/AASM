                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-primary">
                                     <h4 class="text-white">Medicnal Plants</h4>
                                </div>
                                <div class="card-body">
                                <button class=" btn btn-success mb-2" onclick="showmodel()">Add Medicnal Plants</button>
                                ...
                                <table id="table" class="table  table-bordered" style="width:100%">
                                  ...
                                  <tbody class="text-center">
                                    <?php 
                                      ...
                                      <td> 
                                        <button type="button" class="btn btn-danger delete_btn" data-id="<?php echo $data['SL'];?>" data-name="<?php echo $data['Image_Location'];?>" data-url="../../Action/Medicinal.php"><i class="fa-sharp fa-solid fa-trash"></i></button>
                                      </td>
                                    </tr>
                                    <?php
                                     }
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header" style="background-color: #a9caeb;">
                      <h5 class="modal-title" id="exampleModalLabel">Add Medicnal Plants</h5>
                    ...
                    <div class="modal-body">
                      <form id="Value_Store_Form" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                           ...
                           <input type="hidden" id="url" value="../../Action/Medicinal.php">
