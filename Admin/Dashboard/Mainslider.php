                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-primary">
                                     <h4 class="text-white">Main Slider Image's</h4>
                                </div>
                                <div class="card-body">
                                <button class=" btn btn-success mb-2" onclick="showmodel()">Add Main Slider Picture</button>
                                ...
                                <table id="table" class="table  table-bordered" style="width:100%">
                                   <thead>
                                    <tr>
                                      ...
                                      <th scope="col">Image Encrypted Name</th>
                                  ...
                                  <tbody class="text-center">
                                    <?php 
                                      ...
                                      <td><?php echo $data['ImageTitle']; ?></td>
                                      <td><?php echo $data['Image_Name']; ?></td>
                                      <td><img src="../../Document/MainSlider/<?php echo $data['Image_Name'];?>" height=100px,width=100px;></td>
                                      <td><?php echo $data['Date'];?></td>
                                      <td> 
                                        <button type="button" class="btn btn-danger delete_btn" data-id="<?php echo $data['SL'];?>" data-name="<?php echo $data['Image_Name'];?>" data-url="../../Action/Mainpage.php"><i class="fa-sharp fa-solid fa-trash"></i></button>
                                      </td>
                                    </tr>
                                    <?php
                                     }
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header" style="background-color: #a9caeb;">
                      <h5 class="modal-title" id="exampleModalLabel">Add Main Slider Image</h5>
                    ...
                    <div class="modal-body">
                      <form id="Value_Store_Form" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleInputEmail1"style="font-size: 18px;">Image Title</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" Name="ImageTitle" required>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                           ...
                           <input type="hidden" id="url" value="../../Action/Mainpage.php">
...
<?php
  ...
  include("Footer.php");
   ?>
<script>
  function showmodel(sl,imglocation)
  {
    $("#imageid").val(sl);
    $("#imaglocation").val(imglocation);
     //alert(imglocation);
     $("#mymodel").modal("show");
  }
  function closeModal()
